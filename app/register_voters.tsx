...
import { RightHeaderDropDown, SideBar, TetfundFrame, LeftHeaderComponent, RightHeaderComponent } from "./_layout";
...
function RegisterVoters() {
    ...
    return <SafeAreaView style={styles.safe_area_styles}>
        ...
        <View style={styles.container}>
            ...
            <Text onPress={() => router.push('/search_registered_voters')} style={styles.continue_btn}>Continue</Text>
        </View>
